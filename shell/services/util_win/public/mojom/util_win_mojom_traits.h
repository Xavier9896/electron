...
#include "electron/shell/services/util_win/public/mojom/util_win.mojom-shared.h"
...
template <>
struct StructTraits<util_win::mojom::FileFilterSpecDataView, ui::FileFilterSpec> {
